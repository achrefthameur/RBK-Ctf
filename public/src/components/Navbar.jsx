            ...
            <nav className="navbar navbar-expand-lg Nav-Container">
                ...
                <div className="navbar-rightCh" id="navbarText">
                    ...
                    <li className="nav-item active">
                        <a className="nav-link NavBar-item"  href="#">ScoreBoard <span className="sr-only">(current)</span></a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link NavBar-item" href="#">Challanges</a>
                    </li>
                    <li className="nav-item">
                        <a className="nav-link NavBar-item" href="#">Register</a>
                    </li>
                    </ul>
